...
**Tests**: 테스트 태스크는 기본 포함합니다. 최소 `lint` 1회와 영향 범위 테스트
태스크(단위/통합/계약 중 해당 항목)를 반드시 계획합니다.
...
- [ ] T004 [P] Define auth/data-isolation checklist for this feature
- [ ] T005 [P] Identify constants/schema/type sync files and ownership
...
- [ ] T012 Define input validation and failure handling for external inputs
...
### Tests for User Story 1 (MANDATORY for impacted flows) ⚠️
...
### Tests for User Story 2 (MANDATORY for impacted flows) ⚠️
...
### Tests for User Story 3 (MANDATORY for impacted flows) ⚠️
...
- [ ] TXXX Verify constant/type/schema synchronization after final changes
